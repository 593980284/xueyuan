...
@interface EDSNavigationViewController ()<UIGestureRecognizerDelegate,UINavigationControllerDelegate>
...
@property(nonatomic,strong)EDSAnmationController * animationController;
@end

@implementation EDSNavigationViewController
...
- (EDSAnmationController *)animationController
{
    if (_animationController == nil) {
        _animationController = [[EDSAnmationController alloc]init];
