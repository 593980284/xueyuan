...
@interface EDSBrandIntroductionViewController ()<UITableViewDataSource,UITableViewDelegate,EDSHomeTableViewHeaderViewDelegate>
...
//    [self setupNavigationView];
    ...
    _headerView.wz_size = CGSizeMake(kScreenWidth, EDSHomeTableViewHeaderSlideH);
