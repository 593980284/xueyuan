...
- (void)setCoachModel:(EDSCoachListModel *)coachModel
{
    ...
    self.ageLbl.text = coachModel.carNo;;
...
- (void)setup{
    ...
    UILabel *agetagLbl = [UILabel labelWithText:@"绑定车辆：" font:kFont(14) textColor:SecondColor backGroundColor:ClearColor superView:self.contentView];
    [agetagLbl mas_makeConstraints:^(MASConstraintMaker *make) {
        make.left.mas_equalTo(15);
        make.top.mas_equalTo(line.mas_bottom).mas_equalTo(10);
    }];
    
    _ageLbl = [UILabel labelWithText:@"5年" font:kFont(12) textColor:SecondColor backGroundColor:ClearColor superView:self.contentView];
...
//
    ...
    [_tagBgView mas_makeConstraints:^(MASConstraintMaker *make) {
        ...
        make.top.mas_equalTo(self.ageLbl.mas_bottom).mas_equalTo(10);
        make.height.mas_equalTo(35);
    }];
    
    UILabel *descriptiontagLbl = [UILabel labelWithText:@"个人简介：" font:kFont(14) textColor:SecondColor backGroundColor:ClearColor superView:self.contentView];
    [descriptiontagLbl mas_makeConstraints:^(MASConstraintMaker *make) {
        make.left.mas_equalTo(15);
        make.top.mas_equalTo(self.tagBgView.mas_bottom).mas_equalTo(10);
    }];
    _descriptionLbl = [UILabel labelWithText:@"个人简介个人简，介个人简介个人简介个人简介个人简介个人简介个人简介个人简介个人简介个人简介个人简介个人简介个人简介个人简介个人" font:kFont(12) textColor:SecondColor backGroundColor:ClearColor superView:self.contentView];
...
- (void)addTagLblView
{
    UILabel *tagLabel = [UILabel labelWithText:@"教练标签：" font:kFont(14) textColor:SecondColor backGroundColor:ClearColor superView:self.tagBgView];
...
//        NSInteger y = i % 2;
        ...
        UILabel *label = [UILabel labelWithText:self.coachModel.showTagArr[i] font:kFont(12) textColor:[EDSToolClass getColorWithHexString:@"#FF8C00"] backGroundColor:ClearColor superView:self.tagBgView];
        label.textAlignment = NSTextAlignmentCenter;
        label.layer.masksToBounds = YES;
        label.layer.cornerRadius = 5;
        label.layer.borderColor = [EDSToolClass getColorWithHexString:@"#FF8C00"].CGColor;
        label.layer.borderWidth = 1;
        [label mas_makeConstraints:^(MASConstraintMaker *make) {
            make.size.mas_equalTo(CGSizeMake(kRatioY6*50, kRatioY6*15));
            make.centerY.mas_equalTo(self.tagBgView);
            make.left.mas_equalTo(tagLabel.mas_right).offset(4*i+kRatioY6*50*i);
        }];
