...
@interface BaoMingView()<UITableViewDelegate,UITableViewDataSource>
/** tableView */
...
{
    BaoMingTableViewCell * cell = [tableView dequeueReusableCellWithIdentifier:@"BaoMingTableViewCell"];
    if (!cell) {
        cell =  [[NSBundle mainBundle]loadNibNamed:@"BaoMingTableViewCell" owner:self options:nil].firstObject;
    }
